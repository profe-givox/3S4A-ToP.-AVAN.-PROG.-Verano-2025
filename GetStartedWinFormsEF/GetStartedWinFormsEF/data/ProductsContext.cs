...
namespace GetStartedWinFormsEF.data
{
    internal class ProductsContext : Microsoft.EntityFrameworkCore.DbContext
    {
        public DbSet<model.Product> Products { get; set; }
        public DbSet<model.Category> Categories { get; set; }

        string conection = $"Server=localhost;Database=midb;User ID=root;" +
                $"Password=700r;" +
                $"Port=3306;";
